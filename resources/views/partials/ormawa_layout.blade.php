...
<div class="flex h-screen flex-col overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        @php
            ...
            $isPrestasiProposal = Request::is('prestasi/input-proposal');
            $isPrestasiLpj = Request::is('prestasi/upload-lpj');
            $isLaporanPrestasi = Request::is('prestasi/laporan-prestasi/*') || Request::is('prestasi/laporan-prestasi');
            $isPrestasiTemplate = Request::is('prestasi/template-dokumen');
            ...
            <nav id="sidebar-nav" class="flex-1 overflow-y-auto overflow-x-hidden py-2" style="min-width: 16rem;">
                    ...
                    <div id="acc-ormawa-institusi" class="acc-panel" style="max-height: {{ $isOrmawaInstitusiActive ? '1000px' : '0' }}; overflow: hidden;" data-open="{{ $isOrmawaInstitusiActive ? 'true' : 'false' }}">
                        ...
                        <div>
                            <button onclick="toggleAcc('acc-kelola-kegiatan')" class="sidebar-subtoggle {{ $isKelolaKegiatanActive ? 'text-red-600' : '' }}">
                                ...
                                <svg id="chevron-acc-kelola-kegiatan" class="h-3.5 w-3.5 flex-shrink-0 transition-transform duration-200 {{ $isKelolaKegiatanActive ? 'chev-rot' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                </svg>
                            </button>
                    ...
                    <div id="acc-ormawa-prodi" class="acc-panel" style="max-height: {{ $isOrmawaInstitusiActive ? '1000px' : '0' }}; overflow: hidden;" data-open="{{ $isOrmawaInstitusiActive ? 'true' : 'false' }}">
                        ...
                        <div>
                            <button onclick="toggleAcc('acc-kelola-kegiatan-prodi')" class="sidebar-subtoggle {{ $isKelolaKegiatanActive ? 'text-red-600' : '' }}">
                                <span class="flex-1 whitespace-nowrap text-left">Kelola Kegiatan</span>
                                <svg id="chevron-acc-kelola-kegiatan-prodi" class="h-3.5 w-3.5 flex-shrink-0 transition-transform duration-200 {{ $isKelolaKegiatanActive ? 'chev-rot' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                </svg>
                            </button>
                ...
                <div class="sidebar-block mt-2 border-t border-slate-300 pt-2">
                    <button
                        ...
                        class="sidebar-head {{ $isPrestasiMahasiswaActive ? 'text-red-600' : '' }}"
                    >
                        ...
                        <svg id="chevron-acc-prestasi-mahasiswa" class="h-4 w-4 flex-shrink-0 transition-transform duration-200 {{ $isPrestasiMahasiswaActive ? 'chev-rot' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>

                    <div id="acc-prestasi-mahasiswa" class="acc-panel" style="max-height: {{ $isPrestasiMahasiswaActive ? '1000px' : '0' }}; overflow: hidden;" data-open="{{ $isPrestasiMahasiswaActive ? 'true' : 'false' }}">
                        <a href="{{ route('organisasi.beranda_mahasiswa') }}" class="sidebar-link {{ $isBerandaMahasiswa ? 'sidebar-link-active' : '' }}">
                            Beranda
                        </a>

                        <div>
                            <button onclick="toggleAcc('acc-kelola-prestasi')" class="sidebar-subtoggle {{ $isKelolaPrestasiActive ? 'text-red-600' : '' }}">
                                <span class="flex-1 whitespace-nowrap text-left">Kelola Prestasi</span>
                                <svg id="chevron-acc-kelola-prestasi" class="h-3.5 w-3.5 flex-shrink-0 transition-transform duration-200 {{ $isKelolaPrestasiActive ? 'chev-rot' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                </svg>
                            </button>
