...
<div class="min-h-screen bg-gray-100 flex justify-center px-4 py-8">
    <div class="w-full max-w-5xl rounded-2xl bg-white p-6 shadow-lg sm:p-8 lg:p-10">
        ...
        <form method="POST" action="{{ route('organisasi.lpj.update', [$p->id_proposal, 'type' => request()->query('type')]) }}" enctype="multipart/form-data" class="mt-4 space-y-6 sm:mt-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3 pt-4">
                <a href="{{ route('organisasi.create_lpj', ['type' => request()->query('type')]) }}"
